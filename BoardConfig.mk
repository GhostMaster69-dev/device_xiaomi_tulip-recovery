...
# Libraries
TARGET_RECOVERY_DEVICE_MODULES += android.hidl.base@1.0 libdisplayconfig.qti libicuuc libion.so libxml2.so vendor.display.config@1.0 vendor.display.config@2.0
